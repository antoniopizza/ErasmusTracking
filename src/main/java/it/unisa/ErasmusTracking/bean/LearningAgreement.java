...
public class LearningAgreement {
   ...
   * @param stato
   *
   * @param tipologiaErasmus
   *
   * @param listaEsami
   *
   * @param studente
   *
   * @param conoscenzaLingua
   *
  ...
  public LearningAgreement(int id,String dataInizio, String dataFine,String stato,
                           String tipologiaErasmus,ArrayList<MappingEsame> listaEsami,
                           Studente studente, String conoscenzaLingua,
                           String matricolaStudente,ReceivingInstitute receivingInstitute,
