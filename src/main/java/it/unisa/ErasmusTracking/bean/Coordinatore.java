...
public class Coordinatore extends Account {
   ...
   *
   */
  public Coordinatore(String nome, String cognome,ArrayList<Localita> localita,
                      String email, String password, String ruolo,
                      int sendingInstitute, Studente studente,int id) {
  ...
  public String toString() {
    return super.toString()
        +
        "sending_institute= " + sendingInstitute + "\n"
        +
