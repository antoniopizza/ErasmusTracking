...
insert into location (nome,citta, nazione, coordinatore, codice_erasmus) Values ('UniNa','Roma', 'Polonia', 1, 054783);
insert into location (nome,citta, nazione, coordinatore, codice_erasmus) Values ('UniSa','Salerno', 'Italia', 1, 000001);
