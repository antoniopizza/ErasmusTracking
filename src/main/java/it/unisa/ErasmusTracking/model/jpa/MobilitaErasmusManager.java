...
public class MobilitaErasmusManager implements IMobilitaErasmusDao {
  ...
  public synchronized boolean doDelete(int id) {
    ...
    String deleteSql = "DELETE FROM " + MobilitaErasmusManager.TAB_NAME
        +
  ...
  public List<MobilitaErasmus> doRetrieveAll() {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        ISendingInstituteDao sendingInstituteManager =
            new SendingInstituteManager(this.db, this.username, this.password);
        SendingInstitute sendingInstitute =
            (SendingInstitute) sendingInstituteManager.doRetrieveById(idSendingInstitute);

        IReceivingInstituteDao receivingInstituteManager =
            new ReceivingInstituteManager(this.db, this.username, this.password);
        ReceivingInstitute receivingInstitute =
            (ReceivingInstitute) receivingInstituteManager.doRetrieveById(idReceivingInstitute);
  ...
  public Object doRetrieveById(int id) {
    ...
    String selectSql =
        "SELECT * FROM " + MobilitaErasmusManager.TAB_NAME
            +
            " WHERE id_mobilita_erasmus = ?";
    ...
    try {
      ...
      while (rs.next()) {
        ...
        SendingInstitute sendingInstitute =
            (SendingInstitute)
                sendingInstituteManager.doRetrieveById(rs.getInt("sending_institute"));

        IReceivingInstituteDao receivingInstituteManager =
            new ReceivingInstituteManager(this.db, this.username, this.password);
        ReceivingInstitute receivingInstitute =
            (ReceivingInstitute)
                receivingInstituteManager.doRetrieveById(rs.getInt("receiving_institute"));
  ...
  public Object doRetrieveByLearningAgreement(int id) {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        // check sul db
        int idReceivingInstitute =
            rs.getInt("receiving_institute");
        int idSendingInstitute =
            rs.getInt("sending_institute");
        int learningAgreement =
            rs.getInt("learning_agreement");
  ...
  public synchronized List<MobilitaErasmus> doRetrieveByIdSending(int idSending) {
    ...
    List<MobilitaErasmus> list = new ArrayList<>();
    String selectSql =
        "SELECT id_mobilita_erasmus, data_inizio, data_fine, stato, sending_institute, "
            +
        "receiving_institute, learning_agreement FROM "
            +
            MobilitaErasmusManager.TAB_NAME
            +
    ...
    try {
      ...
      while (rs.next()) {
        ...
        SendingInstitute sendingInstitute =
            (SendingInstitute)
                sendingInstituteManager.doRetrieveById(idSendingInstitute);

        IReceivingInstituteDao receivingInstituteManager =
            new ReceivingInstituteManager(this.db, this.username, this.password);
        ReceivingInstitute receivingInstitute =
            (ReceivingInstitute)
                receivingInstituteManager.doRetrieveById(idReceivingInstitute);
