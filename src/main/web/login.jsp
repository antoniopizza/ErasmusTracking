						...
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								...
								<div class="m-login__signin">
									...
									<form action="LoginServlet" method="post" class="m-login__form m-form" action="">
										<div class="form-group m-form__group">
											<input class="form-control m-input" type="text" placeholder="Email" name="e_mail" autocomplete="off">
										</div>
										<div class="form-group m-form__group">
